...
TD_Vec2i TD_to_screen(TD_Vec3 v){
...
// Rasterize a single triangle on the screen
void TD_raster_triangle(TD_Vec3 a, TD_Vec3 b, TD_Vec3 c, TD_Color (*frag_shader)(TD_ShaderInfo*)){
